...
def findEncodings():
    for image in os.listdir('C:/Smart Attendance System/Student DataBase'):
        face_image = fr.load_image_file(f'C:/Smart Attendance System/Student DataBase/{image}')
...
def markAttendance(stud_name, time):
    dir = 'C:/Users/uemin/OneDrive/Attendance/'
...
while True:
    ...
    if process_current_frame:
        ...
        for face_encoding in face_encodings:
            matchers = fr.compare_faces(known_face_encodings, face_encoding)
            name = 'Unknown'
